...
while (my $linea = <MIA>){
	...
	if ($l > 1){
		...
		my $id = 'hCoV-19/'.$a[0].'|'.$a[5].'|'.$a[17];
		$allheaders{$id} += 1;
		my $submitter = $hashSks{$a[4]};
		if ($submitter !~ /[A-Za-z]/){
			$submitter = '?';
		}
...
#			print ROB ("$id\t$a[2]\t$a[3]\t$Region\t$Country\t$Division\t$Location\t$Region\t$Country\t$Division\t$a[6]\t$a[7]\t$a[8]\t$a[9]\t$a[10]\t$a[11]\t$a[12]\t$hashSkO{$a[2]}\t$hashSkS{$a[2]}\t$submitter\t$a[15]\n");
			print ROB ("$id\t$a[4]\t$a[5]\t$Region\t$Country\t$Division\t$Location\t$Region\t$Country\t$Division\t$a[8]\t$a[9]\t$a[10]\t$a[11]\t$a[12]\t$a[13]\t$a[14]\t$hashSkO{$a[4]}\t$hashSkS{$a[4]}\t$submitter\t$a[17]\n");
#			print ROB ("___\t_____\t_____\t_______\t________\t_________\t_________\t_______\t________\t_________\t_____\t_____\t______\t______\t______\t______\t______\t_______________\t_______________\t__________\t______\n");
			$n++;
		} else {
			$allheaders{$id} = 0;
			$m++;
...
#		print ROB ("______\t______________\t____\t______\t_______\t________\t________\t_______________\t________________\t_________________\t______\t____\t___\t___\t_____\t_____________\t_____________\t_______________\t______________\t_________\t______________\n");
	}
}
close (ROB);
close (MIA);
